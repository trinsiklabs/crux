---
layout: post.njk
title: "BIP high-signal event hooks: wire Claude Code hooks to fire BIP triggers (test green, PR merge, new tool)"
date: 2026-03-08
tags: [ship, plan-314]
summary: "BIP high-signal event hooks: wire Claude Code hooks to fire BIP triggers (test green, PR merge, new "
---

# BIP high-signal event hooks: wire Claude Code hooks to fire BIP triggers (test green, PR merge, new tool)

You shipped something big but forgot to tell anyone. If you've run into this, you know exactly what we're talking about.

## The problem
You shipped something big but forgot to tell anyone.
...
## Our approach
Crux notices when something important happens.
...
## How it works
At its core, the implementation hooks into your dev tools to catch key moments. Let's walk through the technical details for readers who want to understand what's happening under the hood.
