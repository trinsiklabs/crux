---
layout: post.njk
title: "Fix deploy-runcrux.io.sh path issue for automated deploys"
date: 2026-03-08
tags: [ship, plan-306]
summary: "Fix deploy-runcrux.io.sh path issue for automated deploys"
---

# Fix deploy-runcrux.io.sh path issue for automated deploys

Deploys breaking? one more thing to debug. If you've run into this, you know exactly what we're talking about.

## The problem
Deploys breaking? one more thing to debug.
...
## How it works
At its core, the implementation resolved path issue in deploy script. Let's walk through the technical details for readers who want to understand what's happening under the hood.
