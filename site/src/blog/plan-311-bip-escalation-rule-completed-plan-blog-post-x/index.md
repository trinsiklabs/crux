---
layout: post.njk
title: "BIP escalation rule: completed plan = blog post, X posts max 1/15min"
date: 2026-03-08
tags: [ship, plan-311]
summary: "BIP escalation rule: completed plan = blog post, X posts max 1/15min"
---

# BIP escalation rule: completed plan = blog post, X posts max 1/15min

Not everything you do is worth posting about. If you've run into this, you know exactly what we're talking about.

## The problem
Not everything you do is worth posting about.
...
## Our approach
Crux knows what matters and what doesn't.
...
## How it works
At its core, the implementation filters activity by impact, skips the noise. Let's walk through the technical details for readers who want to understand what's happening under the hood.
