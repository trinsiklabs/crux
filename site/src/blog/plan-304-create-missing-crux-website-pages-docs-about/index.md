---
layout: post.njk
title: "Create missing Crux website pages: docs/, about/, architecture/, safety-pipeline/, switching/, adopt/"
date: 2026-03-08
tags: [ship, plan-304]
summary: "Create missing Crux website pages: docs/, about/, architecture/, safety-pipeline/, switching/, adopt"
---

# Create missing Crux website pages: docs/, about/, architecture/, safety-pipeline/, switching/, adopt/

People can't find what they need in your docs. If you've run into this, you know exactly what we're talking about.

## The problem
People can't find what they need in your docs.
...
## Our approach
New documentation page — clearer, more complete.
...
## How it works
At its core, the implementation added missing content to the site. Let's walk through the technical details for readers who want to understand what's happening under the hood.
