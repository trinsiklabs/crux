---
layout: post.njk
title: "Site content auto-revision: detect feature changes (tools, modes, tests) and update affected pages automatically"
date: 2026-03-08
tags: [ship, plan-310]
summary: "Site content auto-revision: detect feature changes (tools, modes, tests) and update affected pages a"
---

# Site content auto-revision: detect feature changes (tools, modes, tests) and update affected pages automatically

Docs get outdated the moment you ship. If you've run into this, you know exactly what we're talking about.

## The problem
Docs get outdated the moment you ship.
...
## Our approach
Crux updates your docs when features change.
...
## How it works
At its core, the implementation detects code changes and revises affected pages. Let's walk through the technical details for readers who want to understand what's happening under the hood.
