---
layout: post.njk
title: "Website page: crux adopt - what it does, when to use, BIP integration, session capture, hooks setup, vs crux switch"
date: 2026-03-08
tags: [ship, plan-318]
summary: "Website page: crux adopt - what it does, when to use, BIP integration, session capture, hooks setup,"
---

# Website page: crux adopt - what it does, when to use, BIP integration, session capture, hooks setup, vs crux switch
