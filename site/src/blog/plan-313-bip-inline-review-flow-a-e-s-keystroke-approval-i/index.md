---
layout: post.njk
title: "BIP inline review flow: a/e/s keystroke approval in terminal between work"
date: 2026-03-08
tags: [ship, plan-313]
summary: "BIP inline review flow: a/e/s keystroke approval in terminal between work"
---

# BIP inline review flow: a/e/s keystroke approval in terminal between work

Context switching to approve a tweet breaks your flow. If you've run into this, you know exactly what we're talking about.

## The problem
Context switching to approve a tweet breaks your flow.
...
## Our approach
Approve posts from your terminal. one keystroke..
...
## How it works
At its core, the implementation inline review without leaving your editor. Let's walk through the technical details for readers who want to understand what's happening under the hood.
